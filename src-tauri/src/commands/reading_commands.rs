...
use crate::reading_memo::{
    save_reading_books, ReadingBook, ReadingNote, ReadingSession, ReadingStatus,
};
use crate::AppState;
...
#[tauri::command]
pub fn delete_reading_book(state: State<AppState>, id: String) -> Result<Vec<ReadingBook>, String> {
    let mut books = state.reading_books.lock().unwrap();
