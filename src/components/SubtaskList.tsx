    ...
    return (
        <div className="mt-2">
            ...
            {task.subtasks?.map((subtask) => (
                <div key={subtask.id} className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-bg-hover transition-colors group">
                    <input
                        type="checkbox"
            ...
            {isAdding ? (
                <div className="flex gap-2 mb-2 items-center mt-1">
                    <input
                        ...
                        autoFocus
                    />
                    <button className="px-2 py-1 text-xs rounded border border-border-primary bg-bg-tertiary text-text-primary cursor-pointer hover:bg-bg-hover" onClick={handleAddSubtask}>Add</button>
                    <button className="px-2 py-1 text-xs rounded border border-border-primary bg-bg-tertiary text-text-primary cursor-pointer hover:bg-bg-hover" onClick={() => setIsAdding(false)}>Cancel</button>
                </div>
            ) : (
                <button className="mt-1 text-xs text-accent-primary bg-transparent border-none cursor-pointer p-0 hover:underline flex items-center gap-1" onClick={() => setIsAdding(true)}>
                    + Add Subtask
                </button>
            )}
        </div>
